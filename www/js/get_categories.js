...
// https://gobiernoabierto.cordoba.gob.ar/api/tipo-actividad/?audiencia_id=4
		...
		function handleData(data) {
			$.each(data.results, function(i, category) {
				$('#categories-menu').append('<div class="row" style="margin-top:5px; margin-left:5px;"><li><a href="filtro.html#tipo-'+category.id+'"><div class="col-xs-3"><div class="circle-image-li" style="background-image: url(img/default-event-sq.png);"></div></div><div class="col-xs-9">'+category.nombre+'</div></a></li></div>');
