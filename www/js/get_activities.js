var gobAbiertoAPI = "https://gobiernoabierto.cordoba.gob.ar/api";
		...
		function handleData(data) {
			if (data.count == 0) {
				$('#event-list').append('<div>En este momento no hay actividades disponibles.</div>');
			}else{
				$.each(data.results, function(i, item) {
					...
					var month_end = dateFormat(item.termina, "mmm");
					var day_end = dateFormat(item.termina, "dd");
